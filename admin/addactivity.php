						...
						<li>
							...
							<div id="subActv" class="collapse in">
								<ul class="nav">
									...
									<li><a href="addactivity.php" class="active">添加活动</a></li>
								</ul>
							</div>
						</li>
							...
							<div class="panel">
								...
								<form class="form-horizontal" style="margin-top: 6%">
								  <div class="form-group">
									...
									<div class="col-sm-10">
									  <input type="text" class="form-control" id="inputType" placeholder="请输入活动类型" >
									</div>
								  </div>
								  <div class="form-group">
									<label for="inputActivity" class="col-sm-2 control-label">活动名</label>
									<div class="col-sm-10">
									  <input type="text" class="form-control" id="inputActivity" placeholder="请输入活动名">
									</div>
								  </div>
								  <div class="form-group">
									<label for="inputTime" class="col-sm-2 control-label">活动时间</label>
									<div class="col-sm-10">
									  <input type="text" class="form-control" id="inputTime" placeholder="请选择时间" autocomplete="off">
									</div>
								  </div>
								  <div class="form-group">
								  ...
								  <div class="form-group">
									<div class="col-sm-offset-2 col-sm-10">
									  <button type="button" class="btn btn-success" id="button">确定</button>
									</div>
								  </div>
								</form>
								</div>
		...
		$('#button').on('click',function(){
			...
			if(inputType==""){
				...
				$.post("addact.php",{
					...
					if(data==1){
						layer.msg('添加成功，可前往活动页面查看',{icon:1});
					}else{

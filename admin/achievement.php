							...
							<div class="panel">
								<div class="panel-body">
									<table class="table table-hover">
										...
										<tbody>
										<?php
											$sql="select a_achievement.id,a_achievement.no,name,sex,class,type,activity,term from a_achievement,a_user where a_achievement.no=a_user.no";
											$data=$link->query($sql);
											...
											$offset=($page-1)*$num;
											$sql="select a_achievement.id,a_achievement.no,name,sex,class,type,activity,term from a_achievement,a_user where a_achievement.no=a_user.no limit $offset,{$num}";
											$data=$link->query($sql);

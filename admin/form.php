							...
							<div class="panel">	
								<div class="panel-body">
									<table class="table table-hover">
										...
										<?php 
	                                        $class=$_POST["name"];
	                                        $sql="select id,no,name,sex,class,addtime from a_user where class='$class'";
											$data=$link -> query($sql);
											...
											$offset=($page-1)*$num;
											$sql="select id,no,name,sex,class,addtime from a_user where class='$class' limit $offset,{$num}";
											$data=$link->query($sql);

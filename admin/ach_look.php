	...
	<div id="wrapper">
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
				<?php $id=$_GET['id'];
					$sql="select a_achievement.*,a_user.name from a_achievement,a_user where a_achievement.no=a_user.no and a_achievement.id='$id'";
					$data=$link->query($sql);
					$val=$data->fetch_array();
				?>
					<h3 class="page-title"><?php echo $val['name']?>的个人成就</h3>
					<div class="row">
						...
						<div class="col-md-12" >
							...
							<div class="panel panel-headline">
								<div class="panel-heading">
									<h3 class="panel-title" title="活动名" style="text-align: center;font-size: 30px;cursor:pointer"><?php echo $val['activity']?></h3>
									<p class="panel-subtitle" title="活动类型" style="text-align: center;font-size: 15px;cursor:pointer"><?php echo $val['type'];?></p>
									<h3 class="panel-title" title="标题"><?php echo $val['title']?></h3>
								</div>
								<div class="panel-body">
								<h4>个人心得:</h4>								
									<?php echo $val['content']?>
									<?php 
									   $sqlone="select a_picture.file_path from a_achievement,a_picture where a_achievement.id='$id' and a_achievement.id=a_picture.a_id";
									   $data0=$link->query($sqlone);
										while($val0=$data0->fetch_array()){
									?>
									<img src="../<?php echo $val0['file_path']?>" alt="" class="img-rounded" style="width:49.7%;height: 490px">
									<?php }?>
								</div >
							</div>
							<!-- END PANEL HEADLINE -->

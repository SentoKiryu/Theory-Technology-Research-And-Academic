					...
					<div class="panel-body" >
						<form class="form-horizontal" style=" text-align:center;margin-top: 5%" role="form">
						  <div class="form-group">
							<label class="col-sm-2 control-label" for="grade">活动类型</label>
							 <div class="col-sm-4" style="float: left">
							  <select class="form-control" id="type">
							     <option>请选择活动类型</option>
							  <?php  $sql="select type from a_activity group by type";
									$data=$link->query($sql);
							 ...
							 <label class="col-sm-1 control-label" for="banji">活动名</label>
							 <div class="col-sm-4">
						  ...
						  <div class="form-group">
						    <label class="col-sm-2 control-label" for="time">获奖时间</label>
						  	<div class="col-sm-4">
						  		<input type="text" id="time" class="form-control" placeholder="选择时间" autocomplete="off">
						  	</div>
						  	<label class="col-sm-1 control-label" for="wintime">获奖学期</label>
						  	<div class="col-sm-4">
						  		<input type="text" id="wintime" class="form-control" placeholder="输入获奖学期如：20181">
						  	</div>
						  </div>
                           <div class="form-group">
						   ...
						   <div class="form-group">
							 <label for="inputEdit" class="col-sm-2 control-label">个人成就简述及心得</label>
							 <div class="col-sm-9">
							    <script id="editor" type="text/plain" name="content" style="height:300px;width:100%" ></script>
							 </div>
						  </div>
						    <div class="form-group">
						  ...
						  <div class="form-group">
						  	<label class="col-sm-12 control-label" for="img"></label>
						  </div>
...
//        allowedFileTypes: ['image', 'video', 'flash'],
	...
	}).on("filebatchuploadsuccess",function(event,data){//处理成功后的回调函数
		if(data.response){
